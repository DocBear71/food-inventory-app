...
const CACHE_NAME = 'comfort-kitchen-v1.4.1';
const CACHE_NAMES = {
    STATIC: 'comfort-kitchen-static-v1.4.1',
    API: 'comfort-kitchen-api-v1.4.1',
    IMAGES: 'comfort-kitchen-images-v1.4.1',
    VOICE: 'comfort-kitchen-voice-v1.4.1',
    PRICE: 'comfort-kitchen-price-v1.4.1'
};
...
console.log('🐻 Doc Bear\'s Comfort Kitchen Service Worker v1.4.1 loaded with international support!');