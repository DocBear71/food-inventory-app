        ...
        try {
            if (PlatformDetection.isIOS()) {
                ...
                try {
                    ...
                    console.warn('App plugin not available, using fallback');
            ...
            if (PlatformDetection.isIOS()) {
                ...
                if (openInApp) {
                    ...
                    try {
                        ...
                        console.warn('Browser plugin not available, using fallback');
                        window.open(url, '_blank');
                        return { success: true, platform: 'web-fallback', url };
                    }
                } else {
        ...
        try {
            if (PlatformDetection.isIOS()) {
                ...
                try {
                    ...
                    console.warn('App plugin not available for gesture setup');
                    // No navigation here - just return that gesture setup failed
                    return { success: false, platform: 'ios-fallback', error: error.message };
                }
        ...
        try {
            if (PlatformDetection.isIOS()) {
                ...
                try {
                    ...
                    console.warn('StatusBar plugin not available, using fallback');
                    return { success: true, platform: 'web' };
                }
            } else {
