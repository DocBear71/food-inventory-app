...
export default function ConsumptionHistory({onClose}) {
    ...
    return (
        ...
        >
            {/* FIXED: Better modal structure with proper height management */}
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
                <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl h-[95vh] flex flex-col">
                    {/* Fixed Header */}
                    <div className="bg-gray-50 px-4 sm:px-6 py-4 border-b border-gray-200 flex-shrink-0">
                    ...
                    {/* FIXED: History List - Properly scrollable with adequate height */}
                                            ...
                                            <div key={index}
                                                ...
                                                <div className="flex items-start justify-between">
                                                    <div className="flex items-start space-x-3 flex-1 min-w-0">
                                                        <div className="text-2xl flex-shrink-0">{reasonInfo.icon}</div>
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="space-y-1">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <span
                                                                        className="truncate">{formatDate(record.dateConsumed)}</span>
                                                                </div>
                                                    ...
                                                    <div
                                                        className="text-right flex flex-col items-end ml-4 flex-shrink-0">
