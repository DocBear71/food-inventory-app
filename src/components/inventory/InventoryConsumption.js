'use client';
// file: /src/components/inventory/InventoryConsumption.js v4 - Fixed mobile scrolling and accessibility
...
export default function InventoryConsumption({
    ...
    if (mode === 'recipe') {
        return (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                {/* FIXED: Better mobile layout with proper flex structure */}
                <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[95vh] flex flex-col">
                    ...
                    {/* Fixed Footer */}
                    <div className="border-t border-gray-200 px-6 py-4 bg-gray-50 flex justify-between flex-shrink-0">
                        <TouchEnhancedButton
                            type="button"
                            onClick={onClose}
    ...
    // Single item consumption mode - FIXED mobile layout
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            {/* FIXED: Better mobile responsive modal */}
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[95vh] flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
                        ...
                        {showUnitToggle && (
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <TouchEnhancedButton
                                        type="button"
                                        onClick={() => setConsumptionData(prev => ({
                                            ...prev,
                        ...
                        {/* Reason Selection - IMPROVED for mobile */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                Reason for Update
                            </label>
