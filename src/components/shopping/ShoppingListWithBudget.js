...
// file: /src/components/shopping/ShoppingListWithBudget.js
...
export function ShoppingListWithBudget({ initialItems = [], onItemsChange }) {
    ...
    const getCategoryTotals = () => {
        return items.reduce((totals, item) => {
            ...
            totals[category] = (totals[category] || 0) + (item.estimatedPrice * item.quantity);
            return totals;
        }, {});
    };
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    >
                        <span>💰</span>
                        <span>{showBudgetTracker ? 'Hide Budget' : 'Show Budget'}</span>
                    </TouchEnhancedButton>
                </div>
                    ...
                    <div key={category} className="bg-white rounded-lg shadow-md p-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center justify-between">
                            ...
                            <span className="text-sm text-gray-500">
                                ${categoryItems.reduce((sum, item) => sum + (item.estimatedPrice * item.quantity), 0).toFixed(2)}
                            </span>
                        </h3>
