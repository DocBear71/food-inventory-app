...
export const metadata = {
    ...
    openGraph: {
        ...
        url: process.env.NODE_ENV === 'production' ? 'https://docbearscomfort.kitchen/pricing' : 'http://localhost:3000/pricing',
        images: [
            {
        ...
        "offers": [
            {
                ...
                "url": `${process.env.NODE_ENV === 'production' ? 'https://docbearscomfort.kitchen' : 'http://localhost:3000'}/auth/signup?tier=free`,
            ...
            },
            {
                ...
                "availability": "https://schema.org/InStock",
                "url": `${process.env.NODE_ENV === 'production' ? 'https://docbearscomfort.kitchen' : 'http://localhost:3000'}/auth/signup?tier=gold`,
                "priceValidUntil": "2025-12-31",
            ...
            },
            {
                ...
                "billingIncrement": "P1M",
                "availability": "https://schema.org/InStock",
                "url": `${process.env.NODE_ENV === 'production' ? 'https://docbearscomfort.kitchen' : 'http://localhost:3000'}/auth/signup?tier=platinum`,
                "priceValidUntil": "2025-12-31",
...
export default async function PricingPage({ searchParams }) {
    ...
    return (
        <>
            ...
            <PricingContent searchParams={resolvedSearchParams} />
        </>
    );
}