...
export default function ShoppingPage() {
    ...
    // Helper functions (keeping all your existing logic)
    ...
    // Enhanced ingredient normalization and matching (keeping your existing logic)
    ...
    const ingredientMatches = (searchTerm, ingredient) => {
        ...
        // Add your specific matching rules here...
    ...
    return (
        <MobileOptimizedLayout>
            <div className="max-w-7xl mx-auto">
                    ...
                    fallback={
                        <div className="px-4 py-8">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="text-gray-600">Generate smart shopping lists from your favorite recipes</p>
                            </div>

                            {/* Premium Feature Showcase */}
                            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-8 mb-8 border border-green-200">
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-gray-700 max-w-2xl mx-auto">
                                        Never forget an ingredient again! Generate smart shopping lists from your selected recipes,
                                        with automatic quantity consolidation and organized categories.
                                    </p>
                                </div>

                                {/* Feature Preview - 4 columns */}
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                    <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                                        <div className="text-2xl mb-2">📝</div>
                                        <h3 className="font-semibold text-gray-900 mb-1">Smart Lists</h3>
                                        <p className="text-sm text-gray-600">Auto-consolidate quantities and organize by category</p>
                                    </div>
                                    <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                                        <div className="text-2xl mb-2">🔍</div>
                                        <h3 className="font-semibold text-gray-900 mb-1">Recipe Filtering</h3>
                                        <p className="text-sm text-gray-600">Search by ingredients, tags, and difficulty</p>
                                    </div>
                                    <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                                        <div className="text-2xl mb-2">💾</div>
                                        <h3 className="font-semibold text-gray-900 mb-1">Save & Share</h3>
                                        <p className="text-sm text-gray-600">Save lists for later and share with family</p>
                                    </div>
                                    <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                                        <div className="text-2xl mb-2">📱</div>
                                        <h3 className="font-semibold text-gray-900 mb-1">Mobile Ready</h3>
                                        <p className="text-sm text-gray-600">Take your lists to the store on any device</p>
                                    </div>
                                </div>

                                {/* Mock Shopping List Preview */}
                                <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Preview: Generated Shopping List</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                ...
                >
                    {/* AUTHORIZED USER CONTENT - Shopping List Generator */}
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="text-xs mt-1">
                                                                            {hasContent ? `${availableLetters.length} letters` : 'No tags'}
                                                                        </div>
                                                                    </TouchEnhancedButton>
                                                                );
                                                            })}
                                                            ...
                                                            {tagSections.find(s => s.id === selectedTagSection)?.letters.map(letter => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="text-xs mt-1">
                                                                            {hasContent ? `${letterTags.length} tags` : 'No tags'}
                                                                        </div>
                                                                    </TouchEnhancedButton>
                                                                );
                                                            })}
